...
class EditFragment : Fragment(), AnkoLogger {
    ...
    override fun onCreateView(
        ...
        root.editDuration.setText(editDepositDiary!!.duration.toString())
        ...
        root.editUpdateButton.setOnClickListener {
            ...
            updateUserDepositDiary(app.currentUser!!.uid,
    ...
    fun updateDepositDiaryData() {
        ...
        editDepositDiary!!.duration = root.editDuration.text.toString().toInt()
