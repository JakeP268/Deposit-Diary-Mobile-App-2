...
fun updateAllDepositDiarys(app: DepositDiaryApp) {
    ...
    var donationRef = app.database.ref.child("deposits")
                                  .orderByChild("email")
...
fun checkExistingPhoto(app: DepositDiaryApp, activity: Activity) {
    ...
    app.userImage = "".toUri()
    Log.v("Deposit","checkExistingPhoto 1 app.userImage : ${app.userImage}")
    ...
    app.database.child("user-photos").orderByChild("uid")
        ...
        override fun onDataChange(snapshot: DataSnapshot ) {
            snapshot.children.forEach {
                ...
                Log.v("Deposit","checkExistingPhoto 2 app.userImage : ${app.userImage}")
            }
            Log.v("Deposit","validatePhoto 3 app.userImage : ${app.userImage}")
